...
ConciliationMonthly_expenses_router = APIRouter()
@ConciliationMonthly_expenses_router.post("/ConciliationMonthly_vs_Expenses")
async def get_ConciliationMonthly_vs_expenses(
    ...
    try:
        ...
        resultados = ejecutar_procedimiento_read(
            db, 
            "Admin.sp_Presupuesto_GastoSugerido_vs_GastoMes",
            parametros
        )
        ...
        parametros = {
            ...
            "action_details": "intenta obtener la conciliacion de gastos para el mes ",
            "error" : 1,
            "error_details" : str(e)
        }
