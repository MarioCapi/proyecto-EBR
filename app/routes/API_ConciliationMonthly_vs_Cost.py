...
ConciliationMonthly_cost_router = APIRouter()
@ConciliationMonthly_cost_router.post("/ConciliationMonthly_vs_Cost")
async def get_ConciliationMonthly_vs_Cost(
    ...
    try:
        ...
        resultados = ejecutar_procedimiento_read(
            db, 
            "Admin.sp_Presupuesto_CostoSugerido_vs_CostoMes",
            parametros
        )
